...
void AppConfig::FillArgumentsList(argparse::ArgumentParser &appOptions)
{
   ...
   appOptions.add_argument("-l", "--lines").help("Number of lines").default_value(49).scan<'i', int>();
   appOptions.add_argument("-c", "--columns").help("Number of columns").default_value(81).scan<'i', int>();
